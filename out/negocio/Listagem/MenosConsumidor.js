...
var MenosQuantidade = /** @class */ (function (_super) {
    __extends(MenosQuantidade, _super);
    function MenosQuantidade(cliente) {
        var _this = _super.call(this) || this;
        _this.cliente = cliente;
        return _this;
    }
    MenosQuantidade.prototype.listar = function () {
        var consumidores = [];
    ...
    return MenosQuantidade;
}(listagem_1.default));
exports.default = MenosQuantidade;
